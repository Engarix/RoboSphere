...
\item Stworzenie algorytmów kinematyki napędu różnicowego z uwzględnieniem płynnego narastania prędkości (\textit{ramping}) w celu ochrony mechanicznych elementów układu.
\item Analizę stabilności połączenia i bezpieczeństwa pracy robota poprzez mechanizmy kontroli stanu klienta (\textit{watchdog}).
\end{itemize}